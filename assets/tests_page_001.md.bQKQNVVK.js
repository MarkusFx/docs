import{C as E}from"./chunks/theme.DL0-XTPY.js";import{_ as T,p as r,h as b,v as N,$ as q,q as V,c as p,o as g,e as Z,n as L,j as s,a3 as x,aA as j,t as m,F as z,B as H,ak as M,G as h,a as C,k as t}from"./chunks/framework.BINmV0KU.js";const J={class:"rutube-player"},U=["src"],G=["title"],X={class:"overlay-controls"},O=["disabled","title"],W=["disabled","title"],Y={class:"overlay-playlist"},K=["onClick","title"],Q={__name:"VideoPlayer",props:{videos:{type:Array,required:!0,validator:d=>Array.isArray(d)&&d.every(e=>e&&typeof e.title=="string"&&typeof e.url=="string"&&e.url.includes("rutube.ru"))}},setup(d){const e=d,l=r(e.videos.map(i=>i.url)),a=r(e.videos.map(i=>i.title)),n=r(0),w=b(()=>l.value[n.value]),F=r(null),c=r(!1),o=r(!0);let k=null;function B(){clearTimeout(k),o.value=!0,k=setTimeout(()=>{o.value=!1},3e3)}function $(){B()}function _(){const i=F.value;document.fullscreenElement?document.exitFullscreen():i.requestFullscreen()}function I(){c.value=!!document.fullscreenElement,c.value?B():(o.value=!0,clearTimeout(k))}N(()=>{document.addEventListener("fullscreenchange",I)}),q(()=>{document.removeEventListener("fullscreenchange",I),clearTimeout(k)});const v=b(()=>n.value>0),u=b(()=>n.value<l.value.length-1);function D(){v.value&&n.value--}function R(){u.value&&n.value++}function P(i){n.value=i}return V(()=>e.videos,i=>{l.value=i.map(y=>y.url),a.value=i.map(y=>y.title),n.value>=l.value.length&&(n.value=0)},{deep:!0,immediate:!0}),(i,y)=>(g(),p("div",J,[w.value?(g(),p("div",{key:0,ref_key:"videoContainer",ref:F,class:L(["video-container",{fullscreen:c.value}]),onDblclick:_},[s("iframe",{src:w.value,allow:"autoplay"},null,8,U),s("div",{class:"mouse-layer",onMousemove:$},null,32),x(s("button",{class:"fullscreen-btn",onClick:_,title:c.value?"Выйти из полноэкранного режима":"Полноэкранный режим"},m(c.value?"⨉":"⛶"),9,G),[[j,o.value]]),x(s("div",X,[s("button",{onClick:D,disabled:!v.value,title:v.value?"Предыдущее: "+a.value[n.value-1]:""}," ◀ "+m(v.value?a.value[n.value-1]:""),9,O),s("button",{onClick:R,disabled:!u.value,title:u.value?"Следующее: "+a.value[n.value+1]:""},m(u.value?a.value[n.value+1]:"")+" ▶ ",9,W)],512),[[j,o.value]]),x(s("ul",Y,[(g(!0),p(z,null,H(a.value,(S,f)=>(g(),p("li",{key:f,class:L({active:f===n.value}),onClick:hn=>P(f),title:S},m(S),11,K))),128))],512),[[j,o.value]])],34)):Z("",!0)]))}},A=T(Q,[["__scopeId","data-v-e1dd2021"]]),nn=`<h1>Hello World!</h1>
<button
...
`,ln=`document.addEventListener('DOMContentLoaded', () => {
...
`,dn="",kn=JSON.parse('{"title":"Тесты","description":"","frontmatter":{},"headers":[],"relativePath":"tests/page_001.md","filePath":"tests/page_001.md"}'),cn={name:"tests/page_001.md"},vn=Object.assign(cn,{setup(d){const e=[{title:"001. Введение в курс",url:"https://rutube.ru/play/embed/e2398aad0e4c42a9ab4889bd2efd35ba"},{title:"002. Python3 vs. Python2",url:"https://rutube.ru/play/embed/cdc3e5bd2218bb30dc83ff4fcb193ed8"},{title:"003. Упражнения",url:"https://rutube.ru/play/embed/ab65a293ab9e9e31df65979a17a543c2"},{title:"004. С чего начать",url:"https://rutube.ru/play/embed/89c8553872844f21a7ef5444aecf3227"},{title:"005. Структура курса",url:"https://rutube.ru/play/embed/4b258a4229e95ab70510d18c3a97f314"}],l=[{title:"006. Зачем использовать командную строку",url:"https://rutube.ru/play/embed/ee26cc540b318f3b1686cdc9d089758f"},{title:"007. Командная строка на MAC",url:"https://rutube.ru/play/embed/ac6982e509a4d2d9c8af9618f1f68e23"},{title:"008. Абсолютные пути и PWD",url:"https://rutube.ru/play/embed/c01d7b7786e2225db61a8be91c55883f"},{title:"009. Использование CD",url:"https://rutube.ru/play/embed/e159ffb3a7497f1e7437bad7f0ee1279"},{title:"010. Использование LS",url:"https://rutube.ru/play/embed/bea9b0679d937754a951df2d0e33239a"}];return(a,n)=>(g(),p("div",null,[n[0]||(n[0]=M('<h1 id="тесты" tabindex="-1">Тесты <a class="header-anchor" href="#тесты" aria-label="Permalink to &quot;Тесты&quot;">​</a></h1><h2 id="player" tabindex="-1">Player <a class="header-anchor" href="#player" aria-label="Permalink to &quot;Player&quot;">​</a></h2><h3 id="введение-в-курс" tabindex="-1">Введение в курс <a class="header-anchor" href="#введение-в-курс" aria-label="Permalink to &quot;Введение в курс&quot;">​</a></h3>',3)),h(A,{videos:e}),n[1]||(n[1]=s("h3",{id:"mac-linux-основы-команднои-строки",tabindex:"-1"},[C("MAC, LINUX - Основы командной строки "),s("a",{class:"header-anchor",href:"#mac-linux-основы-команднои-строки","aria-label":'Permalink to "MAC, LINUX - Основы командной строки"'},"​")],-1)),h(A,{videos:l}),n[2]||(n[2]=s("h2",{id:"menu-grid",tabindex:"-1"},[C("Menu Grid "),s("a",{class:"header-anchor",href:"#menu-grid","aria-label":'Permalink to "Menu Grid"'},"​")],-1)),h(E,{html:t(on),css:t(rn),js:t(dn),height:"900px"},null,8,["html","css","js"]),n[3]||(n[3]=s("h2",{id:"menu-grid-1",tabindex:"-1"},[C("Menu Grid "),s("a",{class:"header-anchor",href:"#menu-grid-1","aria-label":'Permalink to "Menu Grid"'},"​")],-1)),h(E,{html:t(tn),css:t(an),js:t(ln),height:"910px"},null,8,["html","css","js"]),n[4]||(n[4]=M(`<h2 id="iframe-c-html-css-javascript" tabindex="-1">iframe c HTML, CSS, JavaScript <a class="header-anchor" href="#iframe-c-html-css-javascript" aria-label="Permalink to &quot;iframe c HTML, CSS, JavaScript&quot;">​</a></h2><p><strong><code>index.html</code></strong>:</p><div class="language-html vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">h1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;Hello World!&lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">h1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><p><strong><code>script.js</code></strong>:</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">console.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">log</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;Preview loaded!&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><p>Результат:</p>`,8)),h(E,{html:t(nn),css:t(sn),js:t(en),height:"170px"},null,8,["html","css","js"])]))}});export{kn as __pageData,vn as default};
