...
// export const expressCard = [makeCard('Express', expressLogo, 'green')]
// export const nestjsCard = [makeCard('NestJS', nestjsLogo, 'red')]
// export const threejsCard = [makeCard('Three.js', threejsLogo, 'blue')]
...
// export const webrtcCard = [makeCard('WebRTC', webrtcLogo, 'green')]
...
export const gsapCard = [makeCard('GSAP', gsapLogo, 'silver')]
...
export const expressCard = [makeCard('Express', expressLogo, 'silver')]
export const nestjsCard = [makeCard('NestJS', nestjsLogo, 'silver')]
export const threejsCard = [makeCard('Three.js', threejsLogo, 'silver')]
...
export const webrtcCard = [makeCard('WebRTC', webrtcLogo, 'silver')]
