...
<!--            >-->
<!--                &lt;!&ndash; Паук на фоне &ndash;&gt;-->
<!--                &lt;!&ndash;                <SpiderEgor&ndash;&gt;-->
<!--                &lt;!&ndash;                    ref="spider"&ndash;&gt;-->
<!--                &lt;!&ndash;                    :style="{&ndash;&gt;-->
...
<!--                &lt;!&ndash;                        transform: `translate(${x}px, ${y}px) scale(${zoom})`,&ndash;&gt;-->
<!--                &lt;!&ndash;                        transformOrigin: '0 0',&ndash;&gt;-->
<!--                &lt;!&ndash;                        zIndex: 0,&ndash;&gt;-->
<!--                &lt;!&ndash;                    }"&ndash;&gt;-->
<!--                &lt;!&ndash;                />&ndash;&gt;-->
...
import { Background } from '@vue-flow/background'
import TileGrid from './TileGridForGraph.vue'
// Импорты карточек (оставил как есть, убедитесь, что пути верные)
import {
    htmxCard,
    gsapCard,
    cssCard,
...
// Оптимизация: используем shallowRef, чтобы не отслеживать глубоко вложенные свойства
